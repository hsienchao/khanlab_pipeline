...
parser.add_argument("--hic", "-i", metavar="HiC MASTER", help="HiC Master file", default="/data/khanlab/projects/HiC/manage_samples/HiC_sample_sheet.xlsx")
#parser.add_argument("--hic", "-i", metavar="HiC MASTER", help="HiC Master file", default="/data/khanlab/projects/HiC/manage_samples/HiC_sample_sheet_Jun.xlsx")
